...
const About = () => {
    return (
        <div className="container about" id="about">
            ...
            <p className="lower-p">My favorite part of coding is the problem solving to figure out what you need to put the pieces of an app together, such as APIs to connect front end to the database, or thinking through the elements needed to create a filter for multiple fields. That's why I especially love back end development. I currently have used such languages and frameworks as HTML/HTML5, CSS, JavaScript, React, MySQL, Node, Express, and MongoDB.</p>
